                    ...
                    <div class="container-fluid rounded p-3 w-100" :class="'bg-' + theme.c1">
                        ...
                        <form @submit.prevent="submitPost" class="px-2">
                            ...
                            <div class="form-floating mb-2">
                                <textarea required name="postContent" id="postContent" v-model="postContent" class="form-control border-0 me-0" :class="'text-' + theme.c2" :style="'background-color:' + [ theme.c1 == 'dark' ? '#151515' : '#E9E9E9' ]" style="min-height: 150px"></textarea>
                                <label for="postContent" class="pt-3" :class="'text-' + theme.c2">Comment content</label>
                            </div>
