            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="container-fluid rounded p-3 w-100" :class="'bg-' + theme.c1">
                        <h3 class="px-2 mb-3" :class="'text-' + theme.c2">Sign In</h3>
                        <form @submit.prevent="signIn" class="px-2">
                            ...
                            <div class="form-floating mb-2 d-flex">
                                ...
                                <button @click="toggleShowPassword" type="button" class="border-0 rounded-0 rounded-end btn" :class="'text-' + theme.c2" style="margin: -50px">
                                    <i class="bi" :class="'bi-eye' + [showPassword ? '' : '-slash']"></i>
                                </button>
                            </div>
                            <div class="text-secondary w-100 fst-italic" style="font-size: 0.9rem">There are no real accounts. You can type whatever you want!</div>
